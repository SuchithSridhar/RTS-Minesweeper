...
/**
 * The initMenusBundle function creates the initial data for the MenusBundle struct
...
/**
 * The initStartGameSettings function creates the initial data for the StartSettings struct
 * Memory is allocated using malloc and must be freed using the sibling function
...
/**
 * The initStatistics function creates the initial data for the Statistics struct
 * Memory is allocated using malloc and must be freed using the sibling function
 * freeStatistics
 * @param menu_bundle pointer to a MenusBundle struct
 * @param screen_width represents the current screen width
 ...
 * @param titles is a array of pointers of strings corresponding to the button titles
 * @param screen_width represents the current screen width
 * @param screen_height represents the current screen height
 * @return A menu button pointer which points to the new menu button array
 */
MenuButton *createMenuButtonArray(int num_menu_button, char **titles, int *screen_width, int *screen_height);
...
/**
 * The freeMenuButtonArray function frees the dynamically allocated memory assigned to a MenuButton array
...
/**
 * The drawStartMenu function uses a StartMenu struct to draw the buttons and the title of the start menu
...
/**
 * The drawStartGameSettings function uses a StartSettings struct to draw the buttons of the game initialization menu
...
/**
 * The drawSettings function uses a Settings struct to draw the buttons and GUI of the settings menu
...
/**
 * The drawStatistics function uses a Statistics struct to draw the buttons of the statistics menu
...
/**
 * The handleGUIDraw function determines which draw function to call, and whether or not a button needs to be highlighted or not
...
/**
 * The setStartGameBounds function sets creates the rectangle bounds for the buttons in the StartSettings struct
 * @param start_settings pointer to a StartSettings struct
 * @param screen_width represents the current screen width
 * @param screen_height represents the current screen height
 */
...
/**
 * The setSettingsBounds function sets creates the rectangle bounds for the buttons in the Settings struct
 * @param settings pointer to a Settings struct
 * @param screen_width represents the current screen width
 * @param screen_height represents the current screen height
 */
...
/**
 * The setStatsBounds function sets creates the rectangle bounds for the buttons in the Statistics struct
 * @param statistics pointer to a Statistics struct
 * @param screen_width represents the current screen width
 * @param screen_height represents the current screen height
 */
 ...
 * @param mp a pointer to a Vector2 which represents the current position of the mouse
 * @param start_index the first index to check hover
 * @param end_index the last index to check hover 
 * @return bool | true if the mp is over the bounds of one of the MenuButtons, false otherwise
*/
bool checkHover(MenuButton *menu_button_array, Vector2 *mp, int start_index, int end_index);
...
/**
 * The startHover function determines whether or not a button is being hovered, and if so change the button hover variable to reflect this
...
/**
 * The startSettingsHover function determines whether or not a button is being hovered, and if so change the button hover variable to reflect this
 * @param mp a pointer to a Vector2 struct representing the current mouse position
...
/**
 * The settingsHover function determines whether or not a button is being hovered, and if so change the button hover variable to reflect this
 * @param mp a pointer to a Vector2 struct representing the current mouse position
...
/**
 * The statisticsHover function determines whether or not a button is being hovered, and if so change the button hover variable to reflect this
 * @param mp a pointer to a Vector2 struct representing the current mouse position
...
/**
 * The handleStateClicks function handles whether or not a click will result in a state change
 * @param menu_bundle a pointer to a MenusBundle struct
 * @param mp a pointer to a Vector2 struct representing the current position of the mouse.
 * @param state a pointer to an integer representing the state
 */
...
/**
 * The handleStartMenuClick function changes the state depending on whether or not a click has occured over a state changing button
 * @param menu a pointer to a StartMenu struct
 * @param state a pointer to an integer representing the state
 */
...
/**
 * The handleStartGameClick function changes the state depending on whether or not a click has occured over a state changing button
 * @param start_settings a pointer to a StartSettings struct
 * @param state a pointer to an integer representing the state
 */
...
/**
 * The handleSettingsClick function changes the state depending on whether or not a click has occured over a state changing button
 * @param settings a pointer to a Settings struct
 * @param state a pointer to an integer representing the state
 */
...
/**
 * The handleStatisticsClick function changes the state depending on whether or not a click has occured over a state changing button
 * @param state a pointer to an integer representing the state
 */
